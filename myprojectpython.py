#veuillez utiliser le compilateur  https://codeboot.org/py/ puisque des  images et quelques éléments  sont pré-enregistrer par le prof  la bas merci beaucoup :D
def init():
